            ...
            <main className="grid grid-cols-1 xl:grid-cols-12 gap-4 sm:gap-6">
                ...
                <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="p-4 sm:p-6">
                        ...
                        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-3 sm:p-4 text-center hover:shadow-md transition-all">
                            <p className={`font-semibold text-sm sm:text-base ${isAdmin ? "text-indigo-600" : "text-green-600"}`}>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    {loading ? (
                        ...
                        {purchases.map((purchase, index) => (
                            <div key={purchase._id} className="transform hover:scale-[1.01] transition-all">
